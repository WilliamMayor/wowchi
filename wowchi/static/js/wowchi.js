...
function Category(details, parent) {
    ...
    self.all_achievements = _.map(details.achievements, function(a) {
        return new Achievement(self, a);
    });
    self.achievements = ko.pureComputed(function() {
        var q = wowchi.search_query().toLowerCase();
        return ko.utils.arrayFilter(self.all_achievements, function(achi) {
            var keep = true;
            if (!!q) {
...
function Wowchi() {
    ...
    self.explore = ko.observable();
    self.character_class_faction = ko.pureComputed(function() {
    ...
    self.find_achievement = function(aid, categories) {
        ...
        _.find(categories, function(category) {
            a = _.find(category.all_achievements, function(achievement) {
    ...
    self.find_criterion = function(cid, categories) {
        ...
        var c;
        _.find(categories, function(category) {
             _.find(category.all_achievements, function(achievement) {

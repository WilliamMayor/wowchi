...
var message={template_error:_.template("<li class='error'><%= message %><a class='close' href='javascript:void(0)'><i class='fa fa-times fa-fw'></i></a></li>"),template_warning:_.template("<li class='warning'><%= message %><a class='close' href='javascript:void(0)'><i class='fa fa-times fa-fw'></i></a></li>"),error:function(msg){Rollbar.error(msg);$("#messages").append(message.template_error({message:msg}));},warning:function(msg){Rollbar.warning(msg);$("#messages").append(message.template_warning({message:msg}));},init:function(){$("#messages").on('click','li a.close',function(){$(this).parents("li").remove();});}};var Locale=function(country,locale,host){this.country=country;this.locale=locale;this.host=host;};var Realm=function(name){this.name=name;};var Criterion=function(id,quantity){this.id=id;this.quantity=quantity;};var wowchi={locales:[new Locale('USA','en_US','http://us.battle.net'),new Locale('Mexico','es_MX','http://us.battle.net'),new Locale('Brazil','pt_BR','http://us.battle.net'),new Locale('UK','en_GB','http://eu.battle.net'),new Locale('Spain','es_ES','http://eu.battle.net'),new Locale('France','fr_FR','http://eu.battle.net'),new Locale('Russia','ru_RU','http://eu.battle.net'),new Locale('Germany','de_DE','http://eu.battle.net'),new Locale('Portugal','pt_PT','http://eu.battle.net'),new Locale('Italy','it_IT','http://eu.battle.net'),new Locale('Korea','ko_KR','http://kr.battle.net'),new Locale('Taiwan','zh_TW','http://tw.battle.net'),new Locale('China','zh_CN','http://www.battlenet.com.cn')],races:[{id:1,mask:1,side:"alliance",name:"Human"},{id:1,mask:1,side:"alliance",name:"Human"},{id:2,mask:2,side:"horde",name:"Orc"},{id:2,mask:2,side:"horde",name:"Orc"},{id:3,mask:4,side:"alliance",name:"Dwarf"},{id:3,mask:4,side:"alliance",name:"Dwarf"},{id:4,mask:8,side:"alliance",name:"Night Elf"},{id:4,mask:8,side:"alliance",name:"Night Elf"},{id:5,mask:16,side:"horde",name:"Undead"},{id:5,mask:16,side:"horde",name:"Undead"},{id:6,mask:32,side:"horde",name:"Tauren"},{id:6,mask:32,side:"horde",name:"Tauren"},{id:7,mask:64,side:"alliance",name:"Gnome"},{id:7,mask:64,side:"alliance",name:"Gnome"},{id:8,mask:128,side:"horde",name:"Troll"},{id:8,mask:128,side:"horde",name:"Troll"},{id:9,mask:256,side:"horde",name:"Goblin"},{id:10,mask:512,side:"horde",name:"Blood Elf"},{id:11,mask:1024,side:"alliance",name:"Draenei"},{id:11,mask:1024,side:"alliance",name:"Draenei"},{id:22,mask:2097152,side:"alliance",name:"Worgen"},{id:24,mask:8388608,side:"neutral",name:"Pandaren"},{id:25,mask:16777216,side:"alliance",name:"Pandaren"},{id:26,mask:33554432,side:"horde",name:"Pandaren"}],classes:[{id:3,mask:4,powerType:"focus",name:"Hunter"},{id:4,mask:8,powerType:"energy",name:"Rogue"},{id:1,mask:1,powerType:"rage",name:"Warrior"},{id:2,mask:2,powerType:"mana",name:"Paladin"},{id:7,mask:64,powerType:"mana",name:"Shaman"},{id:8,mask:128,powerType:"mana",name:"Mage"},{id:5,mask:16,powerType:"mana",name:"Priest"},{id:6,mask:32,powerType:"runic-power",name:"Death Knight"},{id:11,mask:1024,powerType:"mana",name:"Druid"},{id:9,mask:256,powerType:"mana",name:"Warlock"},{id:10,mask:512,powerType:"energy",name:"Monk"}],working:ko.observable(false),locale:ko.observable(),realm:ko.observable(),realms:ko.observableArray(),character_name:ko.observable(),character_class:ko.observable(7),character_race:ko.observable(2),exploring:ko.observable(),completed:ko.observableArray(),criteria:ko.observableArray(),available:ko.observableArray(),queue:ko.observableArray(),opened:ko.observableArray()};wowchi.icon=function(name,size){if(!size){size=36;}
return"http://media.blizzard.com/wow/icons/"+size+"/"+name+".jpg";};wowchi.open_category=function(section){if(wowchi.opened.indexOf(section.name)!==-1){wowchi.opened.remove(section.name);}else{wowchi.opened.push(section.name);}};wowchi.explore_achi=function(achi){if(wowchi.exploring()===achi){wowchi.exploring(null);}else{wowchi.exploring(achi);}};wowchi.close_explore=function(){wowchi.exploring(null);};wowchi.criterion_met=function(criterion){var earned=_.find(wowchi.criteria(),function(c){return c.id===criterion.id;});if(earned){return earned.quantity>=criterion.max;}
return false;};wowchi.add_to_queue=function(){wowchi.queue.push(wowchi.exploring());};wowchi.remove_from_queue=function(achi){wowchi.queue.remove(achi);};wowchi.category_is_opened=function(category){return wowchi.opened.indexOf(category.name)!==-1;};wowchi.achi_is_completed=function(achi){return wowchi.completed.indexOf(achi.id)!==-1;};wowchi.is_exploring=function(achi){return wowchi.exploring()===achi;};wowchi.wowhead_link=function(){return'http://www.wowhead.com/achievement='+wowchi.exploring().id;};wowchi.can_add_to_queue=function(){var achi=wowchi.exploring();return wowchi.queue.indexOf(achi)===-1&&!wowchi.achi_is_completed(achi);};wowchi.character_class_faction=ko.computed(function(){var race=wowchi.character_race();var faction=_.pluck([_.find(wowchi.races,function(r){return r.id===race;})],"side")[0];var cc=wowchi.character_class();var _class=_.pluck([_.find(wowchi.classes,function(c){return c.id===cc;})],"name")[0].toLowerCase();return faction+" "+_class;});wowchi.url=function(endpoint){try{return wowchi.locale().host+endpoint+"?jsonp=?&locale="+wowchi.locale().locale;}catch(e){return null;}};wowchi.achievements=function(wowchi){try{return[wowchi.locale().host,"/api/wow/character/",wowchi.realm().name,"/",wowchi.character_name(),"?jsonp=?&fields=achievements&locale="+wowchi.locale().locale].join("");}catch(e){return null;}};wowchi.find=function(){Rollbar.configure({payload:{person:{id:wowchi.locale().locale+"."+wowchi.realm().name+"."+wowchi.character_name()}}});Rollbar.info("User finding data");wowchi.working(true);$.ajax(wowchi.url("/api/wow/data/character/achievements"),{dataType:"jsonp",jsonp:"jsonp",jsonpCallback:"jsonpCallback"}).done(function(data,textStatus,jqXHR){wowchi.available(data.achievements);wowchi.find_completed();}).fail(function(jqXHR,textStatus,errorThrown){console.error(jqXHR,textStatus,errorThrown);message.error("There was an error fetching global achivement data, please try again");});};wowchi.find_completed=function(){wowchi.working(true);$.ajax(wowchi.achievements(wowchi),{dataType:"jsonp",jsonp:"jsonp",jsonpCallback:"jsonpCallback"}).done(function(data,textStatus,jqXHR){wowchi.character_class(data.class);wowchi.character_race(data.race);wowchi.completed(data.achievements.achievementsCompleted);wowchi.criteria(_.map(data.achievements.criteria,function(c,i){return new Criterion(c,data.achievements.criteriaQuantity[i]);}));wowchi.load_queue();}).fail(function(jqXHR,textStatus,errorThrown){console.error(jqXHR,textStatus,errorThrown);message.error("There was an error fetching character achivement data, please try again");}).always(function(data_jqXHR,textStatus,jqXHR_errorThrown){wowchi.working(false);});};wowchi.update_realms=function(){wowchi.working(true);$.ajax(wowchi.url("/api/wow/realm/status"),{dataType:"jsonp",jsonp:"jsonp",jsonpCallback:"jsonpCallback"}).done(function(data,textStatus,jqXHR){wowchi.realms(_.map(data.realms,function(r){return new Realm(r.name);}));}).fail(function(jqXHR,textStatus,errorThrown){console.error(jqXHR,textStatus,errorThrown);message.error("There was an error fetching realm data, please try again");}).always(function(data_jqXHR,textStatus,jqXHR_errorThrown){wowchi.working(false);});};wowchi.queue.subscribe(function(){_.each(wowchi.queue(),function(a){if(wowchi.achi_is_completed(a)){wowchi.queue.remove(a);}});wowchi.save_queue();});wowchi.save_queue=function(){try{var key=wowchi.locale().host+"."+wowchi.realm().name+"."+wowchi.character_name()+".queue";localStorage[key]=ko.toJSON(wowchi.queue);}catch(e){}};wowchi.load_queue=function(){try{var key=wowchi.locale().host+"."+wowchi.realm().name+"."+wowchi.character_name()+".queue";wowchi.queue(wowchi.find_many(wowchi.available(),JSON.parse(localStorage[key]||'[]')));}catch(e){}};wowchi.find_obj=function(haystack,needle,key){if(!needle){return null;}
return _.find(haystack,function(l){return l[key]===needle[key];});};wowchi.find_many=function(haystack,needles){return _.filter(_.map(needles,function(needle){return wowchi.find_achi(haystack,needle);}),function(o){return o!==null;});};wowchi.find_achi=function(all,achi){var i,j;if(!achi){return null;}
for(i=0;i<all.length;i++){if(all[i].achievements){for(j=0;j<all[i].achievements.length;j++){if(all[i].achievements[j].id===achi.id){return all[i].achievements[j];}}}
if(all[i].criteria){for(j=0;j<all[i].criteria.length;j++){if(all[i].criteria[j].id===achi.id){return all[i].criteria[j];}}}}
return null;};wowchi.load_from_storage=function(){if('localStorage'in window&&window.localStorage!==null){wowchi.locale(wowchi.find_obj(wowchi.locales,JSON.parse(localStorage.locale||'null'),'locale'));wowchi.realms(_.map(JSON.parse(localStorage.realms||'[]'),function(r){return new Realm(r.name);}));wowchi.realm(wowchi.find_obj(wowchi.realms(),JSON.parse(localStorage.realm||'null'),'name'));wowchi.character_name(JSON.parse(localStorage.character_name||'null'));wowchi.character_class(JSON.parse(localStorage.character_class||'7'));wowchi.character_race(JSON.parse(localStorage.character_race||'2'));wowchi.available(JSON.parse(localStorage.available||'[]'));wowchi.exploring(wowchi.find_achi(wowchi.available(),JSON.parse(localStorage.exploring||'null')));wowchi.completed(JSON.parse(localStorage.completed||'[]'));wowchi.criteria(JSON.parse(localStorage.criteria||'[]'));wowchi.queue(wowchi.find_many(wowchi.available(),JSON.parse(localStorage.queue||'[]')));if(wowchi.locale()&&wowchi.locale().locale&&wowchi.realm()&&wowchi.realm().name&&wowchi.character_name()){Rollbar.configure({payload:{person:{id:wowchi.locale().locale+"."+wowchi.realm().name+"."+wowchi.character_name()}}});Rollbar.info("User coming back");}
wowchi.locale.subscribe(function(){localStorage.locale=ko.toJSON(wowchi.locale);});wowchi.realms.subscribe(function(){localStorage.realms=ko.toJSON(wowchi.realms);});wowchi.realm.subscribe(function(){localStorage.realm=ko.toJSON(wowchi.realm);});wowchi.character_name.subscribe(function(){localStorage.character_name=ko.toJSON(wowchi.character_name);});wowchi.character_class.subscribe(function(){localStorage.character_class=ko.toJSON(wowchi.character_class);});wowchi.character_race.subscribe(function(){localStorage.character_race=ko.toJSON(wowchi.character_race);});wowchi.exploring.subscribe(function(){localStorage.exploring=ko.toJSON(wowchi.exploring);});wowchi.available.subscribe(function(){localStorage.available=ko.toJSON(wowchi.available);});wowchi.completed.subscribe(function(){localStorage.completed=ko.toJSON(wowchi.completed);});wowchi.criteria.subscribe(function(){localStorage.criteria=ko.toJSON(wowchi.criteria);});}else{message.warning("Your browser doesn't have localStorage. This means your character data and achivement queue won't be saved for the next time you visit. Sorry.");}
wowchi.locale.subscribe(wowchi.update_realms);};$(document).ready(function(){$('#queue').waypoint('sticky');$('#exploring').waypoint('sticky');ko.applyBindings(wowchi);wowchi.load_from_storage();message.init();});